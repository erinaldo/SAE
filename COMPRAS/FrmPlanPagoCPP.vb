...
Public Class FrmPlanPagoCPP
    ...
    Public Sub cargarclientes()
        Try
            ...
            Next
            FrmSelCliente.lbform.Text = "informe_xproveedor"
    ...
    Private Sub cmdpantalla_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdpantalla.Click
        ...
        per = "PERIODO INICIAL: " & fecha1.Text & " - PERIODO FINAL: " & fecha2.Text & ""
        ...
        tt = "INFORME PROVEEDORES PLAN DE PAGOS "
        ...
        If c1.Checked = True Then ' Todos proveedor 
       ...
       & " FROM ctas_x_pagar c, terceros t WHERE c.nitc=t.nit AND c.total > c.pagado "
        ...
        End If  ' Fin todos proveedor 

        If c2.Checked = True Then ' Un proveedor 
       ...
       & " IF ( (SELECT DATEDIFF( NOW( ) , (SELECT ADDDATE( c.fecha, INTERVAL c.vmto DAY) ) ) ) > " & r33 & " AND (SELECT DATEDIFF( NOW( ) , (SELECT ADDDATE( c.fecha, INTERVAL c.vmto DAY) ) ) ) < " & r4 & " , (c.total - c.pagado), 0 ) AS vpos, " _
       & " IF ( (SELECT DATEDIFF( NOW( ) , (SELECT ADDDATE( c.fecha, INTERVAL c.vmto DAY) ) ) ) > " & r5 & ", (c.total - c.pagado), 0 ) AS tasa, (total - pagado) AS total " _
       & " FROM ctas_x_pagar c, terceros t WHERE c.nitc= '" & txtnitc.Text & "' AND t.nit= '" & txtnitc.Text & "' AND c.total > c.pagado "
        ...
        '        Exit Sub
        '    End If
        '    sql = "SELECT nitc FROM ctas_x_pagar WHERE total>pagado AND (fecha>='" & f1 & "' AND fecha<='" & f2 & "') group BY nitc order by nomnit;"
        ...
        '        sql = "SELECT * FROM ctas_x_pagar WHERE nitc='" & txtnitc.Text & "' AND total>pagado AND fecha>='" & f1 & "' AND fecha<='" & f2 & "' ORDER BY nitc;"
        '        GenerarPDF_individual(sql)
        '    Else
        '        sql = "SELECT * FROM ctas_x_pagar WHERE nitc='" & txtnitc.Text & "' AND total>pagado AND fecha>='" & f1 & "' AND fecha<='" & f2 & "' ORDER BY doc;"
        '        GenerarPDF_individual(sql)
        '    End If
        'End If
    ...
    Public Sub GenerarPDF_todos(ByVal sql As String)
        Try
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "PLAN DE PAGOS A PROVEEDORES", 300, 755, 0)
    ...
    Public Sub imprime_individual_grupo(ByVal cad As String)
        Try
            ...
            cb.ShowTextAligned(50, "PROVEEDOR:" & nom, 2, k, 0)
    ...
    Public Sub estadistica_individual()
        ...
        Dim f1, f2, cad As String
        If c1.Checked = True Then
            cad = " "
        Else
            cad = " and nitc ='" & Trim(txtnitc.Text) & "' "
        End If
        ...
        Try
            ...
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext FROM ctas_x_pagar where total>pagado and  DATEDIFF('" & f2 & "',fecha) <='" & venc1 & "' " & cad & " and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            myAdapter.Fill(tabla)
        ...
        Try
            ...
            tabla2 = New DataTable
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext  FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha) >'" & venc1 & "' and DATEDIFF('" & f2 & "',fecha) <='" & venc2 & "' " & cad & " and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            myAdapter.Fill(tabla2)
            'imprime_individual(txtnitc.Text)
            Refresh()
        ...
        Try
            ...
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha) >'" & venc2 & "' and DATEDIFF('" & f2 & "',fecha) <='" & venc3 & "' " & cad & " and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
        ...
        Try
            ...
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext  FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha)>'" & venc3 & "' and DATEDIFF('" & f2 & "',fecha)<='" & venc4 & "' " & cad & " and fecha>='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            ...
            Try
                ...
                myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha)>'" & venc4 & "' " & cad & " and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
                myAdapter.SelectCommand = myCommand
    ...
    Public Sub estadistica_grupo(ByVal nit As String)
        ...
        Try
            ...
            Dim recibe As New Object
            ' Filtro de Fecha si Existe.----
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext  FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha) <='" & venc1 & "' and nitc ='" & nit & "' and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            myAdapter.Fill(tabla)
            'imprime_individual(txtnitc.Text)
            Refresh()
        ...
        Try
            tabla2 = New DataTable
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext  FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha)>'" & venc1 & "' and DATEDIFF('" & f2 & "',fecha)<='" & venc2 & "' and nitc ='" & nit & "'and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            myAdapter.Fill(tabla2)
            'imprime_individual(txtnitc.Text)
            Refresh()
        ...
        Try
            tabla3 = New DataTable
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha)>'" & venc2 & "' and DATEDIFF('" & f2 & "',fecha)<='" & venc3 & "' and nitc ='" & nit & "' and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            myAdapter.Fill(tabla3)
            'imprime_individual(txtnitc.Text)
            Refresh()
        ...
        Try
            ...
            tabla4 = New DataTable
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext  FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha)>'" & venc3 & "' and DATEDIFF('" & f2 & "',fecha)<='" & venc4 & "' and nitc ='" & nit & "' and fecha>='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            myAdapter.SelectCommand = myCommand
            myAdapter.Fill(tabla4)
            'imprime_individual(txtnitc.Text)
            Refresh()
            ...
            Try
                tabla5 = New DataTable
                myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc,doc_ext FROM ctas_x_pagar where total>pagado and DATEDIFF('" & f2 & "',fecha)>'" & venc4 & "' and nitc ='" & nit & "' and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(tabla5)
                'imprime_individual(txtnitc.Text)
                Refresh()
    ...
    Private Sub FrmPlanPagoCPP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
