Public Class FemFPE2
    Dim FinEdit As Integer
    Private Sub FemFPE2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With gcuenta
            .AlternatingRowsDefaultCellStyle.BackColor = Color.White
            .DefaultCellStyle.BackColor = Color.FloralWhite
        End With
        If FrmNuevoEgreso.gce.Enabled = True Then
            Me.gcuenta.Enabled = True
        Else
            Me.gcuenta.Enabled = False
        End If
    End Sub
