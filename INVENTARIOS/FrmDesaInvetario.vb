Public Class FrmDesaInvetario

    Private Sub FrmDesaInvetario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Dim tabla As New DataTable
            myCommand.CommandText = "SELECT entradas,salidas FROM parinven;"
    ...
    Public Sub DesaFactura()
        MiConexion(bda)
        Try
            myCommand.CommandText = "UPDATE movimientos" & PerActual(0) & PerActual(1) & " " _
            ...
            If FrmPrincipal.cmdAuditoria.Visible = True Then
                Guar_MovUser("INVENTARIO", "DESAPROBAR DOC: " & txttipo.Text & txtnumfac.Text, "", "", "")
            End If
    ...
    Public Sub Contable()
        Try
            myCommand.CommandText = "DELETE FROM documentos" & PerActual(0) & PerActual(1) & " " _
    ...
    Public Sub RecuperarCantidades()
        Try
            Dim tabla As New DataTable
            myCommand.CommandText = "SELECT * FROM deta_mov" & PerActual(0) & PerActual(1) & " " _
