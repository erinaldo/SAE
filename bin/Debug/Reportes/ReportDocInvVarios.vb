...
Public Class ReportDocInvVarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportDocInvVarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tdoc() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportDocInvVarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDocInvVarios = New ReportDocInvVarios
        rpt.Site = Me.Site
        Return rpt
    End Function
