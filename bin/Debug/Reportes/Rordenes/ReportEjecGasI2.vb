...
Public Class ReportEjecGasI2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportEjecGasI2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportEjecGasI2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportEjecGasI2 = New ReportEjecGasI2
        rpt.Site = Me.Site
        Return rpt
    End Function
