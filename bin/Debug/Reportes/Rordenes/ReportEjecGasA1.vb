...
Public Class ReportEjecGasA1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportEjecGasA1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportEjecGasA1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportEjecGasA1 = New ReportEjecGasA1
        rpt.Site = Me.Site
        Return rpt
    End Function
