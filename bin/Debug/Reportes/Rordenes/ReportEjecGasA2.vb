...
Public Class ReportEjecGasA2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportEjecGasA2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportEjecGasA2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportEjecGasA2 = New ReportEjecGasA2
        rpt.Site = Me.Site
        Return rpt
    End Function
