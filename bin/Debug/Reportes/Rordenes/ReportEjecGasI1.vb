...
Public Class ReportEjecGasI1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportEjecGasI1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportEjecGasI1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportEjecGasI1 = New ReportEjecGasI1
        rpt.Site = Me.Site
        Return rpt
    End Function
