...
Public Class ReportFactGanancia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportFactGanancia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportFactGanancia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportFactGanancia = New ReportFactGanancia
        rpt.Site = Me.Site
        Return rpt
    End Function
