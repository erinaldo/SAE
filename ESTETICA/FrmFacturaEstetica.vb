...
Public Class FrmFacturaEstetica
    ...
    Private Sub cmditems_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmditems.Click
        ...
        MiConexion(bda)
        Cerrar()
        FrmItemsEst.txtnumfac.Text = txtnumfac.Text
        FrmItemsEst.txtfecha.Text = txtfecha.Text
        FrmItemsEst.txttipo.Text = txttipo.Text
        FrmItemsEst.txttipo2.Text = txttipo2.Text
        FrmItemsEst.lbnit.Text = txtnitc.Text
        FrmItemsEst.gitems.RowCount = 1
        Try
            FrmItemsEst.gitems.Rows.Clear()
        Catch ex As Exception
        End Try
        FrmItemsEst.gitems.RowCount = gfactura.RowCount
        ...
        For i = 0 To gfactura.RowCount - 1
            Try
                ...
                If lb_imp_dec.Text = "S" Then
                    pre = CDbl(gfactura.Item(4, i).Value)
                End If
                FrmItemsEst.gitems.Item("num", i).Value = i + 1
                FrmItemsEst.gitems.Item("tipo", i).Value = gfactura.Item("tipo", i).Value
                FrmItemsEst.gitems.Item("codigo", i).Value = gfactura.Item(1, i).Value
                FrmItemsEst.gitems.Item("descrip", i).Value = gfactura.Item(2, i).Value
                FrmItemsEst.gitems.Item("cant", i).Value = gfactura.Item(3, i).Value
                'FrmItemsEst.gitems.Item("precio", i).Value = gfactura.Item(4, i).Value
                FrmItemsEst.gitems.Item("precio", i).Value = pre
                FrmItemsEst.gitems.Item("bodega", i).Value = gfactura.Item(7, i).Value
                FrmItemsEst.gitems.Item("iva", i).Value = gfactura.Item("iva", i).Value
                '/////////////////////////////////////////////////////////////////////////////
                FrmItemsEst.gitems.Item("codcom", i).Value = gfactura.Item("cc", i).Value
                FrmItemsEst.gitems.Item("ctainv", i).Value = gfactura.Item("ctainv", i).Value
                FrmItemsEst.gitems.Item("ctacven", i).Value = gfactura.Item("ctacven", i).Value
                FrmItemsEst.gitems.Item("ctaing", i).Value = gfactura.Item("ctaing", i).Value
                FrmItemsEst.gitems.Item("ctaiva", i).Value = gfactura.Item("ctaiva", i).Value
                FrmItemsEst.gitems.Item("descuento", i).Value = Moneda2(gfactura.Item("descuento", i).Value, lb_imp_dec.Text)
                FrmItemsEst.gitems.Item("nit", i).Value = gfactura.Item("nit", i).Value.ToString
                FrmItemsEst.gitems.Item("precio2", i).Value = gfactura.Item("precio2", i).Value
                'FrmItemsEst.gitems.Item("preiva", i).Value = gfactura.Item("precio2", i).Value
            Catch ex As Exception

            End Try
        Next
        FrmItemsEst.lbiva.Text = lbprecioiva.Text
        FrmItemsEst.gitems.Columns(1).ReadOnly = False  'tipo I/S
        FrmItemsEst.gitems.Columns(6).ReadOnly = False  'bodega
        If lbcomicion.Text = "NO" Then
            FrmItemsEst.gitems.Columns("cc").ReadOnly = True  'NO hay concepto comicionable
        Else
            FrmItemsEst.gitems.Columns("cc").ReadOnly = False  'SI hay concepto comicionable
        End If
        FrmItemsEst.lbform.Text = "frs"
        FrmItemsEst.LbTipoMov.Text = "salidas"
        FrmItemsEst.gitems.Focus()
        FrmItemsEst.ShowDialog()
        FrmItemsEst.lbiva.Text = "NO"
        FrmItemsEst.gitems.Columns("cc").ReadOnly = False
        CalcularTotales()
    End Sub
    ...
    Public Sub cargarvendedor()
        Try
            ...
            Next
            FrmSelVendedor.lbform.Text = "frs"
    ...
    Private Sub CmdMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdMostrar.Click
        ...
        FrmSelFacturaVenta.lbform.Text = "frs"
    ...
    Private Sub cmdobservaciones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdobservaciones.Click
        ...
        FrmObsrvaciones.lbform.Text = "frs"
    ...
    Public Sub GenerarTicket()
       ...
       & " FROM parafacgral "
        ...
        file.WriteLine("NIT. " & tablacomp.Rows(0).Item("nit") & " " & tablaR.Rows(0).Item("tipocompa"))
        ...
        file.WriteLine("SEÑORES: " & txtcliente.Text)
    ...
    Private Sub cmdConceptos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConceptos.Click
        ...
        'Catch ex As Exception
        'End Try
        'FrmOtrosConceptos.lbform.Text = "frs"
        ...
        FrmOtrosConceptosProv.lbform.Text = "frs"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        FrmSelMovInventario.lbform.Text = "FacturaEst"
