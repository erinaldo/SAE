...
Public Class FrmEstadoCuentas
    ...
    Public Sub cargarclientes()
        Try
            ...
            Next
            FrmSelCliente.lbform.Text = "inf_car_est_cta"
    ...
    Private Sub cmdpantalla_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdpantalla.Click
        ...
        'If c1.Checked = True Then
        '    sql = "SELECT nitc FROM cobdpen WHERE pagado<total AND (fecha>='" & f1 & "') group BY nitc order by nomnit;"
        ...
        '        sql = "SELECT * FROM cobdpen WHERE nitc='" & txtnitc.Text & "' AND pagado<total AND fecha>='" & f1 & "' ORDER BY nitc;"
        '        GenerarPDF_individual(sql)
        '    Else
        '        sql = "SELECT * FROM cobdpen WHERE nitc='" & txtnitc.Text & "' AND pagado<total AND fecha>='" & f1 & "' ORDER BY doc;"
        '        GenerarPDF_individual(sql)
        '    End If
        'End If
        ...
        & " WHERE c.nitc=t.nit AND c.total > c.pagado AND c.fecha > '" & fc & "' "
        ...
        & " IF ( (SELECT DATEDIFF( NOW( ) ,  (SELECT ADDDATE(  c.fecha, INTERVAL c.vmto DAY) ) ) ) > " & r5 & ", (c.total - c.pagado), 0 ) AS tasa, " _
        & " (total - pagado) AS total FROM cobdpen c, terceros t " _
        & " WHERE c.nitc = '" & txtnitc.Text & "' AND  t.nit= '" & txtnitc.Text & "' AND c.total > c.pagado AND c.fecha > '" & fc & "' "
    ...
    Public Sub Banner2()
        ...
        cb.ShowTextAligned(50, "FECHA INICIAL: " & fecha1.Text & "  FECHA FINAL: " & DateTime.Now, 2, 770, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "ESTADO DE CUENTA", 300, 755, 0)
        cb.ShowTextAligned(50, "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ", 0, 745, 0)
        k = 735
        ' Imprimer Datos de la Persona
        k = k - 10
        'imprime_individual()
        'imprime_individual_grupo(tablax.Rows(i).Item(0))
        k = k - 5
        cb.ShowTextAligned(50, "Apreciados Señores", 2, k, 0)
        If Trim(txtleyenda.Text) <> "" Then
            k = k - 10
            cb.ShowTextAligned(50, txtleyenda.Text, 2, k, 0)
        End If
        k = k - 10
    ...
    Public Sub GenerarPDF_individual(ByVal sql As String)
        Try
            ...
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "ESTADO DE CUENTA", 300, 752, 0)
            fuente = FontFactory.GetFont(FontFactory.HELVETICA_BOLD, iTextSharp.text.Font.DEFAULTSIZE, iTextSharp.text.Font.NORMAL).BaseFont
            cb.SetFontAndSize(fuente, 8)
    ...
    Public Sub estadistica_individual()
        ...
        Try
            ...
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc  FROM cobdpen where vmto <='" & Trim(Str(venc1)) & "' and nitc ='" & Trim(txtnitc.Text) & "' and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado, fecha, vmto,doc FROM cobdpen where  pagado<total and  DATEDIFF(now(),fecha)<='" & venc1 & "' and nitc ='" & Trim(txtnitc.Text) & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            tabla2 = New DataTable
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc  FROM cobdpen where vmto >'" & Trim(Str(venc1)) & "' and vmto <='" & Trim(Str(venc2)) & "' and nitc ='" & Trim(txtnitc.Text) & "'and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc1 & "' and DATEDIFF(now(),fecha)<='" & venc2 & "' and nitc ='" & Trim(txtnitc.Text) & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc FROM cobdpen where vmto >'" & Trim(Str(venc2)) & "' and vmto <='" & Trim(Str(venc3)) & "' and nitc ='" & Trim(txtnitc.Text) & "' and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc2 & "' and  DATEDIFF(now(),fecha)<='" & venc3 & "' and nitc ='" & Trim(txtnitc.Text) & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc  FROM cobdpen where vmto >'" & Trim(Str(venc3)) & "' and vmto <='" & Trim(Str(venc4)) & "' and nitc ='" & Trim(txtnitc.Text) & "' and fecha>='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where  pagado<total and  DATEDIFF(now(),fecha)>'" & venc3 & "' and DATEDIFF(now(),fecha)<='" & venc4 & "' and nitc ='" & Trim(txtnitc.Text) & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc FROM cobdpen where vmto >'" & Trim(Str(venc4)) & "' and nitc ='" & Trim(txtnitc.Text) & "'and fecha >='" & f1 & "' and fecha <='" & f2 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc4 & "' and nitc ='" & Trim(txtnitc.Text) & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
    ...
    Public Sub estadistica_grupo(ByVal nit As String)
        ...
        Try
            ...
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc  FROM cobdpen where vmto <='" & Trim(Str(venc1)) & "' and nitc ='" & nit & "' and fecha >='" & f2 & "' and fecha <='" & f1 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado, fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)<='" & venc1 & "' and nitc ='" & nit & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            tabla2 = New DataTable
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc  FROM cobdpen where vmto >'" & Trim(Str(venc1)) & "' and vmto <='" & Trim(Str(venc2)) & "' and nitc ='" & nit & "'and fecha >='" & f2 & "' and fecha <='" & f1 & "' group by doc;"
            'E'lse
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc1 & "' and DATEDIFF(now(),fecha)<='" & venc2 & "' and nitc ='" & nit & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            tabla3 = New DataTable
            'If filtrofecha.Checked Then
            ' myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc FROM cobdpen where vmto >'" & Trim(Str(venc2)) & "' and vmto <='" & Trim(Str(venc3)) & "' and nitc ='" & nit & "' and fecha >='" & f2 & "' and fecha <='" & f1 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc2 & "' and DATEDIFF(now(),fecha)<='" & venc3 & "' and nitc ='" & nit & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            ...
            'If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc  FROM cobdpen where vmto >'" & Trim(Str(venc3)) & "' and vmto <='" & Trim(Str(venc4)) & "' and nitc ='" & nit & "' and fecha>='" & f2 & "' and fecha <='" & f1 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc3 & "' and DATEDIFF(now(),fecha)<='" & venc4 & "' and nitc ='" & nit & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
        ...
        Try
            tabla5 = New DataTable
            '   If filtrofecha.Checked Then
            'myCommand.CommandText = "SELECT sum(total), tipo,total,pagado , fecha, vmto,doc FROM cobdpen where vmto >'" & Trim(Str(venc4)) & "' and nitc ='" & nit & "'and fecha >='" & f2 & "' and fecha <='" & f1 & "' group by doc;"
            'Else
            myCommand.CommandText = "SELECT sum(total-pagado), tipo,(total-pagado) AS total,pagado , fecha, vmto,doc FROM cobdpen where pagado<total and  DATEDIFF(now(),fecha)>'" & venc4 & "' and nitc ='" & nit & "' AND fecha>='" & f1 & "' group BY doc;"
            'End If
