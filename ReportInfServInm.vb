...
Public Class ReportInfServInm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportInfServInm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportInfServInm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportInfServInm = New ReportInfServInm
        rpt.Site = Me.Site
        Return rpt
    End Function
