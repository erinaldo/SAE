...
Public Class FrmFacturasyAjustes
        ...
        Try
            ...
            If tcr.Rows(0).Item("persona") = "juridica" And tcr.Rows(0).Item("retecree") = "SI" Then
                ...
                If tr.Rows.Count > 0 Then
                    valorretCree.Text = Moneda(tr.Rows(0).Item("tarifa"))
    ...
    Public Sub CalcularTotales()
        ...
        txttotal.Text = Moneda2(st + CDbl(txtiva.Text) - CDbl(txtrtefuente.Text) - CDbl(txtrica.Text) - CDbl(txtriva.Text) - CDbl(txtdescuento.Text) - CDbl(txtretCre.Text))
    ...
    Private Sub CmdMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdMostrar.Click
        ...
        FrmSelFacturaVenta.lbform.Text = "fn"
    ...
    Public Sub ValidarGuardar()
        ...
        ElseIf txtdescuento.Text <> Moneda(0) And txtcuentadesc.Text = "" And txtcuentadesc.Enabled = True Then
            ...
            txtcuentadesc.Focus()
            Exit Sub
        ElseIf valor_rtfuente.Text <> Moneda(0) And txtctaretef.Text = "" And txtctaretef.Enabled = True Then
            MsgBox("No ha escojido cuenta para la Rete Fuente, Verifique.  ", MsgBoxStyle.Information, "Editar Factura ")
            txtctaretef.Focus()
            Exit Sub
        ElseIf valorretCree.Text <> Moneda(0) And txtcuentaCree.Text = "" And txtcuentaCree.Enabled = True Then
            MsgBox("No ha escojido cuenta para la Rete Cree, Verifique.  ", MsgBoxStyle.Information, "Editar Factura ")
            txtcuentaCree.Focus()
            Exit Sub
        ElseIf valor_rtica.Text <> Moneda(0) And txtctarica.Text = "" And txtctarica.Enabled = True Then
            MsgBox("No ha escojido cuenta para el Rete I.C.A, Verifique.  ", MsgBoxStyle.Information, "Editar Factura ")
            txtctarica.Focus()
            Exit Sub
        ElseIf valor_rtiva.Text <> Moneda(0) And txtctariva.Text = "" And txtctariva.Enabled = True Then
    ...
    Private Sub cmdobservaciones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdobservaciones.Click
        ...
        FrmObsrvaciones.lbform.Text = "fn"
    ...
    Private Sub txtcuentadesc_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcuentadesc.DoubleClick
        ...
        FrmCuentas.lbform.Text = "fn_desc"
    ...
    Private Sub txtctarica_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtctarica.DoubleClick
        FrmCuentas.lbaux.Text = "auxiliar"
        FrmCuentas.lbform.Text = "fn_rtica"
        FrmCuentas.ShowDialog()
    End Sub
    ...
    Private Sub txtctariva_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtctariva.DoubleClick
        FrmCuentas.lbaux.Text = "auxiliar"
        FrmCuentas.lbform.Text = "fn_rtiva"
        FrmCuentas.ShowDialog()
    End Sub
    ...
    Private Sub txtcuentatotal_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcuentatotal.DoubleClick
        FrmCuentas.lbaux.Text = "auxiliar"
        FrmCuentas.lbform.Text = "fn_total"
        FrmCuentas.ShowDialog()
    End Sub
    ...
    Private Sub cmdentrega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdentrega.Click
        ...
        FrmDatosDeEntrega.lbform.Text = "fn"
    ...
    Public Sub generarPDFSupHierr()
        ...
        Try
            ...
            img = iTextSharp.text.Image.GetInstance(My.Application.Info.DirectoryPath & "\Reportes\SUPER\super42.jpg")
        ...
        fuente = FontFactory.GetFont(FontFactory.HELVETICA_BOLD, iTextSharp.text.Font.DEFAULTSIZE, iTextSharp.text.Font.NORMAL).BaseFont
        cb.SetFontAndSize(fuente, 9)
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "SUBTOTAL", 352, 191, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, Moneda2(txtsubtotal.Text), 542, 191, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "RETEFUENTE " & valor_rtfuente.Text & "%", 352, 180, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, Moneda2(txtrtefuente.Text), 542, 180, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "RETECREE " & valorretCree.Text & "%", 352, 167, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, Moneda2(txtretCre.Text), 542, 167, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "RETEICA " & valor_rtica.Text & "%", 352, 155, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, Moneda2(txtrica.Text), 542, 155, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "IVA " & valoriva.Text & "%", 352, 142, 0)
        cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, Moneda2(txtiva.Text), 542, 142, 0)
        k = 142
        For j = 0 To cbsr.Items.Count - 1
            k = k - 12
            ...
            End If
        Next
        cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, Moneda2(txttotal.Text), 542, k - 12, 0)
        cb.EndText()
        pdfw.Flush()
        oDoc.Close()
    ...
    Private Sub BannSuper()
        ...
        If tablad.Rows(0).Item("tipof1") = txttipo.Text And tablad.Rows(0).Item("hr1") = "SI" Then
            cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, "RESOLUCION DIAN No " & tablad.Rows(0).Item("reso1") & " DE FECHA ", 300, k + 60, 0)
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, tablad.Rows(0).Item("fecexp1") & "Factura por computador Nro. " & tablad.Rows(0).Item("ini1") & " al " & tablad.Rows(0).Item("fin1"), 180, k + 45, 0)
        ...
        ElseIf tablad.Rows(0).Item("tipof4") = txttipo.Text And tablad.Rows(0).Item("hr2") = "SI" Then
            cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, "RESOLUCION DIAN No " & tablad.Rows(0).Item("reso1") & " DE FECHA ", 300, k + 60, 0)
            cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, tablad.Rows(0).Item("fecexp1") & "Factura por computador Nro. " & tablad.Rows(0).Item("ini1") & " al " & tablad.Rows(0).Item("fin1"), 2180, k + 45, 0)
        End If
    ...
    Public Sub NGenerarPDF()
        ...
        Try
            ...
            prrtf.Name = "rtf"
            prrtf.CurrentValues.AddValue(Moneda(txtrtefuente.Text.ToString))
            prrti.Name = "rti"
            prrti.CurrentValues.AddValue(Moneda(txtriva.Text.ToString))
            prrtic.Name = "rtic"
            prrtic.CurrentValues.AddValue(Moneda(txtrica.Text.ToString))
            prrtc.Name = "rtc"
            prrtc.CurrentValues.AddValue(Moneda(txtretCre.Text.ToString))
    ...
    Private Sub cmdConceptos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConceptos.Click
        ...
        FrmOtrosConceptosProv.lbform.Text = "fn"
