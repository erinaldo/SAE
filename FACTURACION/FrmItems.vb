Public Class FrmItems
    ...
    Private Sub FrmItems_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If lbform.Text = "fr" Or lbform.Text = "fn" Or lbform.Text = "fn_sp" Then
        ...
        Try
            ...
            If Trim(tc.Rows(0).Item("comventa").ToString) = "NO" Or Trim(tc.Rows(0).Item("comventa").ToString) = "no" Then
                gitems.Columns("cc").ReadOnly = True
            Else
                gitems.Columns("cc").ReadOnly = False
            End If
        ...
        Try
            If LbTipoMov.Text = "salidas" And lbform.Text <> "fr" And lbform.Text <> "fn" And lbform.Text <> "fn_sp" And lbform.Text <> "fp" Then
        ...
        Try
            Select Case e.ColumnIndex
                ...
                Case 7 ' CASO CONCEPTOS COMISIONABLES
                    If lbform.Text = "fr" Or lbform.Text = "fn" Or lbform.Text = "fn_sp" Then
                        If gitems.Columns("cc").ReadOnly = True Then
    ...
    Public Sub BuscarArticulos(ByVal fila As Integer, ByVal codigo As String, ByVal tipo As String)
        Try
            ...
            Else
                ...
                If (lbform.Text = "fr" And Frmfacturarapida.usacontf = "si") Or (lbform.Text = "fn" And FrmFacturasyAjustes.usacontfn = "si") Or (lbform.Text = "fn_sp" And FrmFacturasyAjustesSP.usacontfn = "si") Then
            ...
            Try
                If lbform.Text = "fn" Or lbform.Text = "fr" Or lbform.Text = "fn_sp" Then
                    Dim tcc As String = ""
                    If lbform.Text = "fn" Or lbform.Text = "fn_sp" Then
                        tcc = "NORMAL"
                    Else
                        tcc = "RAPIDA"
                    End If
                    ...
                    myCommand.CommandText = "select p.concomipre ,c.codcon from  concomi c, parafacts p where p.factura = '" & tcc & "' and p.concomi = c.codcon;"
                    myAdapter.SelectCommand = myCommand
                    myAdapter.Fill(taF)

                    If tabla.Rows.Count <> 0 Then
                        If taF.Rows(0).Item(0) = "S" Then
                            gitems.Item("cc", fila).Value = taF.Rows(0).Item(1).ToString
                        Else
                            gitems.Item("cc", fila).Value = ""
                        End If
                    End If
                End If
            Catch ex As Exception
    ...
    Private Sub cmd_cod_bar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_cod_bar.Click
        FrmBuscarCodBar.lbform.Text = "items"
    ...
    Private Sub cmd_refe_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_refe.Click
        FrmBuscarRefe.lbform.Text = "items"
