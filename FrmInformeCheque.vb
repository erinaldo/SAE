...
Public Class FrmInformeCheque

    Private Sub FrmInformeCheque_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtcuenta_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcuenta.DoubleClick
        Try
            FrmCuentas.lbform.Text = "infCheq"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If ch2.Checked = True Then
            If txtcheque.Text = "" Then
                MsgBox("Verifique el numero del cheque", MsgBoxStyle.Information, "Verificacion")
                Exit Sub
            End If
        End If
    ...
    Private Sub pdf()
        ...
        sql = sql & " SELECT doc_ext, nitcod, nitc, descrip, subtotal, total, nomnit, concepto FROM ("
        ...
        CrReport.Load(My.Application.Info.DirectoryPath & "\Reportes\ReportCheque.rpt")
    ...
    Private Sub BuscarNit()
        Try
            If Trim(txtnit.Text) = "" Then
                txtnombre.Text = ""
                FrmSelCliente.lbform.Text = "inf_cheq"
