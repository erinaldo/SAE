...
Public Class FrmComprOrdenPl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.FrmComprOrdenPl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFrmComprOrdenPl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FrmComprOrdenPl = New FrmComprOrdenPl
        rpt.Site = Me.Site
        Return rpt
    End Function
