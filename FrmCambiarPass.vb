Public Class FrmCambiarPass
    ...
    Private Sub cmdcambiar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdcambiar.Click
        ...
        myCommand.CommandText = "SELECT * from usuarios where login='" & lbusuario.Text & "';"
        ...
        If items = 0 Then
            ...
            Exit Sub
        End If
        TestDecoding(tabla.Rows(0).Item("passw"), actual.Text)
        If sw = 0 Then
    ...
    Private Sub FrmCambiarPass_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        actual.Text = ""
        pass1.Text = ""
        pass2.Text = ""
        actual.Focus()
    End Sub
    Private Sub FrmCambiarPass_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        actual.Text = ""
        pass1.Text = ""
        pass2.Text = ""
    End Sub
    ...
    Public Sub modificar(ByVal passw As String)
        ...
        myCommand.Parameters.AddWithValue("?login", UsuarioActual.ToString)
        ...
        MsgBox("La contraseña fue modifica correctamente ", MsgBoxStyle.Information, "Guardar Datos")
        Cerrar()
        Me.Close()
    End Sub
