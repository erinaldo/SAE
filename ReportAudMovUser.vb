...
Public Class ReportAudMovUser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAE.ReportAudMovUser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAudMovUser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAudMovUser = New ReportAudMovUser
        rpt.Site = Me.Site
        Return rpt
    End Function
